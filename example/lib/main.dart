...
//Repositorio mockado para exemplificação
class Repository {
...
void main() {
  //Aqui observer para todos os estados da aplicação util para gerenciamento de erros ou logs dos estados da aplicação
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  StateXBuilder(
                    //Informo qual a store que gerenciará as mudanças nesse builder
                    store: viewModel,
                    //Parametro opcional. Especifica qual atributos irá escutar as mudanças de estado, caso não passe este atributo o scoped rebuildará a cada mudança da store
                    states: [viewModel.xEmail, viewModel.xPassword],
                    //Parametro informo que será rebuildado quando a store estiver em loading
                    includeLoading: true,
